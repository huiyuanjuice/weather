...
public class MenuSetting {
	...
	public static String appId = "wxf1fdedc8d98f5332";
    public static String appSecret= "183e8187cf06f8538110fac66ee9ad7d"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://8cdepc.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
